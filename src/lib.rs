...
#[derive(Debug)]
pub struct JestRunnerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl JestRunnerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting JestRunner processing");
    
    let mut processor = JestRunnerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = JestRunnerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = JestRunnerProcessor::new(false);
